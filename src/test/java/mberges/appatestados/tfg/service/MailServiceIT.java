...
import mberges.appatestados.tfg.config.Constants;

import mberges.appatestados.tfg.AtestadosApp;
import mberges.appatestados.tfg.domain.User;
 ...
 */
@SpringBootTest(classes = AtestadosApp.class)
